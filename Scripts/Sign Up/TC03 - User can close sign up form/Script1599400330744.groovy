...
WebUI.click(findTestObject('Sign Up Page/buttonCloseSignUp'))

WebUI.verifyElementNotVisible(findTestObject('Sign Up Page/labelSignUp'), FailureHandling.STOP_ON_FAILURE)
