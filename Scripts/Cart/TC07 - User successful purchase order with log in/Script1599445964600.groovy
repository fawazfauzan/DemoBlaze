...
WebUI.setText(findTestObject('Log In Page/inputUsername'), username)
...
WebUI.waitForElementVisible(findTestObject('Cart Page/labelThankYouPurchase'), 0)

WebUI.verifyElementVisible(findTestObject('Cart Page/containPurchaseOrder'))

WebUI.verifyTextPresent(name, false)

WebUI.verifyTextPresent(creditCard, false)

WebUI.verifyTextPresent(totalPrice, false)

WebUI.click(findTestObject('Cart Page/buttonOKThanksPurchase'))

WebUI.verifyElementNotPresent(findTestObject('Cart Page/labelThankYouPurchase'), 0)
