...
WebUI.click(findTestObject('Cart Page/buttonDeleteProduct'))

WebUI.verifyElementNotPresent(findTestObject('Cart Page/labelTitleProduct'), 0)

WebUI.verifyElementNotPresent(findTestObject('Cart Page/labelProductPrice'), 0)

WebUI.verifyElementNotVisible(findTestObject('Cart Page/labelTotalPrice'), FailureHandling.STOP_ON_FAILURE)
